...
public class Main {
    ...
    private static void createFile() {
        File operationsReport = new File("D:\\Java A-level\\module3\\src\\main\\java\\operationsReport.csv");
        try {
    ...
    private static void createAccount(AccountDao accountDao, UserDao userDao) {
        ...
        account.setAccountName("Magic Card");
    ...
    private static void updateAccount(AccountDao accountDao, UserDao userDao) {
        ...
        if (getAccount.isPresent()) {
            ...
            if (newUser.isPresent()) {
                ...
                updateAccount.setAccountName("Master card");
    ...
    private static void createOperation(OperationDao operationDao, AccountDao accountDao) {
        ...
        operation.setType(TypeOperation.EXPENSE);
        operation.setCategory("theatre");
    ...
    public static void updateOperation(OperationDao operationDao) {
        ...
        if (getOperation.isPresent()) {
            ...
            operation.setType(TypeOperation.INCOME);
            operationDao.update(operation);
        }
    }

    private static void operationByPeriod(OperationDao operationDao) {
        LocalDateTime startDate = LocalDateTime.of(2024, Month.FEBRUARY, 9, 4, 5, 00);
        LocalDateTime endEnd = LocalDateTime.of(2024, Month.FEBRUARY, 6, 5, 5, 00);
    ...
    private static void findOperationsByAccountAndPeriod(OperationDao operationDao, UserDao userDao) {
        ...
        LocalDateTime startDate = LocalDateTime.of(2024, Month.FEBRUARY, 12, 10, 10, 00);
        LocalDateTime endDate = LocalDateTime.of(2024, Month.FEBRUARY, 10, 10, 10, 00);
    ...
    private static void buildReport(UserDao userDao) {
        ...
        LocalDateTime startDate = LocalDateTime.of(2024, Month.FEBRUARY, 12, 10, 10, 00);
        LocalDateTime endDate = LocalDateTime.of(2024, Month.FEBRUARY, 10, 10, 10, 00);
        String operationsReport = "D:\\Java A-level\\module3\\src\\main\\java\\operationsReport.csv";
